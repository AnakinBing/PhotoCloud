...
namespace PhotoCloud.DatabaseClient
{
    public class MySQLClient : IDatabaseClient
    {
        ...
        public MySQLClient(IOptions<DatabaseSettings> options)
        {
        ...
        {
            return this.GetDbConnection().QueryFirstOrDefault<T>(sql, null, this.dbTransaction, commandTimeout, commandType);
        }
        ...
        private IDbConnection GetDbConnection()
        {
            ...
            {
                this.dbConnection = new MySqlConnection(this._settings.ConnectionString);
            }
